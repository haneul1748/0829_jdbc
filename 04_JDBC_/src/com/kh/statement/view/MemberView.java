...
public class MemberView {
	...
	public void mainView() {
		 ...
		 * 
		 * 나만의 테이블에 INSERT / 전체 조회 / 유니크 제약조건 걸려있는 컬럼으로 조회
		 * LIKE 키워드 써서 조회하는거 
		 * 
		 * --> 요게 쫌 부담인데..?
		 * 
	...
	public void findAll() {
		...
		// 데이터좀.. Controller에게 회원들의 데이터 값 요청
		...
		if(members.isEmpty()) {
			...
			for(Member member : members) {
				...
				System.out.println("가입 날짜 : " + member.getEnrollDate());
			}
		}
	...
	private void findByKeyword() {
		...
		// 뷰에서는 뭘 해줘야할까요?
		// 있으면 있다, 없으면 없다고 알려줘야함 
		if(members.isEmpty()) {
			System.out.println("조회된 결과가 존재하지않습니다.");
		} else {

...
public class BoardDAO {
	...
	public List<Board> selectBoardList(Connection conn) {
		...
		try {
			...
			while (rset.next()) {
				...
				Board board = new Board(rset.getInt("BOARD_NO"), rset.getString("BOARD_TITLE"), null,
						rset.getString("USERID"), rset.getDate("CREATE_DATE"), null);
				boards.add(board);
			}
	...
	public Board selectBoard(Connection conn, int boardNo) {
		...
		try {
			...
			if (rset.next()) {
				board = new Board(rset.getInt("BOARD_NO"), rset.getString("BOARD_TITLE"),
						rset.getString("BOARD_CONTENT"), rset.getString("USERID"), rset.getDate("CREATE_DATE"),

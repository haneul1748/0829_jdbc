...
public class TestRun {
	...
	public static void main(String[] args) {
		...
		try {
			...
			e.printStackTrace(); // 프로젝트에 OJDBC를 추가하였나요?
			System.out.println("무조건 57행 문제");
		} catch (SQLException e) {
			e.printStackTrace();
			System.out.println("사용자이름/비밀번호가 잘못됐습니다. -> 61, 62행");
			System.out.println("부적합한 Oracle URL이 지정되었습니다. -> 61행");
			System.out.println("SQL SYNTAX EXception > SQL문 확인하기");
			System.out.println("NULLPointException > JDBC객체들 확인하기");
		} finally {
			try {
				stmt.close();
				conn.close();

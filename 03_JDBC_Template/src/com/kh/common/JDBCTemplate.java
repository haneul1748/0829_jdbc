...
public class JDBCTemplate {
	...
	// DB의 연결정보를 가지고 있는 Connection객체를 생성하여 반환해주는 메소드
	public static Connection getConnection() {
		
		try {
			Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@115.90.212.20:10000:XE","ksky05","KSKY1234");
	...
	// Connection객체를 이용해서 rollback시켜주는 메소드
